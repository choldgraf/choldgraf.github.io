...
```{figure} ./images/jet-lag-basics.jpg
---
name: fig-jet-lag-basics
---
...
```{figure} ./images/jet-lag-east.jpg
---
name: fig-jet-lag-east
---
When you travel east, you need to **advance your clock** (shift it earlier).
```
````
...
```{figure} ./images/jet-lag-west.jpg
---
name: fig-jet-lag-west
---
When you travel west, you need to **delay your clock** (shift it later).
```
````
...
For a deeper dive, check out the [original paper](https://www.frontiersin.org/articles/10.3389/fphys.2019.00927/full).